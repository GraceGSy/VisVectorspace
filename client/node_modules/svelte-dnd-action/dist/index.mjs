...
function validateOptions(options) {
  ...
  var items = options.items,
      ...
      rest = _objectWithoutProperties(options, ["items", "flipDurationMs", "type", "dragDisabled", "dropFromOthersDisabled", "dropTargetStyle", "dropTargetClasses", "transformDraggedElement", "autoAriaDisabled"]);
  /*eslint-enable*/
