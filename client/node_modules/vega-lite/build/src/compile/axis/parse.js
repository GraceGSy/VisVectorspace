...
function parseAxis(channel, model) {
    ...
    for (const property of AXIS_COMPONENT_PROPERTIES) {
        const value = property in axisRules ? axisRules[property](ruleParams) : isAxisProperty(property) ? axis === null || axis === void 0 ? void 0 : axis[property] : undefined;
        ...
        if (hasValue && explicit) {
            ...
            const { configValue = undefined, configFrom = undefined } = isAxisProperty(property)
                ? getAxisConfig(property, model.config, axis === null || axis === void 0 ? void 0 : axis.style, axisConfigs)
                : {};
    ...
    const axisEncoding = (_c = axis === null || axis === void 0 ? void 0 : axis.encoding) !== null && _c !== void 0 ? _c : {};
