export default {
	'defaultVisConstraints' : ['x.field','x.type','x.aggregate','x.channel',
	...
	'defaultMarkConstraints' : ['mark_area','mark_bar','mark_boxplot',
								'mark_circle','mark_errorband','mark_errorbar',
								'mark_line','mark_point','mark_rect',
								'mark_rule','mark_tick']
}